...
const classes = {
  ...
  normal:
    'bg-gray-100 border-gray-300 focus:shadow focus:text-brand-light focus:border-blue-900',
  solid:
    'text-brand-dark border-border-two focus:border-2 focus:outline-none focus:border-blue-900 h-11 md:h-12',
  outline: 'border-gray-300 focus:border-blue-900',
  shadow: 'focus:shadow',
};
