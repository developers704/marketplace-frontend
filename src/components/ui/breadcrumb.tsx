...
export const BreadcrumbItems = (props: any) => {
  ...
  return (
    <div className="flex items-center borobazarBreadcrumb absolute top-0">
  ...
  return (
    <BreadcrumbItems separator={separator}>
      <ActiveLink
        ...
        lang={lang}
      >
        <a className="inline-flex items-center text-lg text-[#9F9F9F]">
      ...
      {breadcrumbs?.map((breadcrumb: any) => (
        <ActiveLink
          href={`${ROUTES.HOME}${lang}${breadcrumb.href}`}
          activeClassName="font-semibold text-heading text-brand-blue"
          key={breadcrumb.href}
          legacyBehavior
          lang={lang}
        >
          <a className="capitalize text-lg text-[#888888]">
