...
function SubscriptionForm({ lang }: { lang: string }) {
  ...
  return (
    ...
    >
      ...
      >
        <SendIcon className="w-[18px] 2xl:w-5 h-[18px] 2xl:h-5 rtl:rotate-180 text-brand-underline_color" />
      </button>
    </form>
  );
}
...
const WidgetSubscription: React.FC<Props> = ({ lang, className }) => {
  ...
  return (
    <div className={cn('flex flex-col mb-6 lg:mb-0', className)}>
      <Heading variant="mediumHeading" className="mb-4 lg:mb-6 lg:pb-0.5 text-brand-light">
        {'Newsletter'}
      </Heading>
