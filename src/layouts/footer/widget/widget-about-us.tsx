...
import LogoWhite from '@/components/ui/logo_white';
  ...
  return (
    <div className={`pb-10 sm:pb-0 ${className}`}>
      <div className="flex flex-col text-center sm:ltr:text-left sm:rtl:text-right max-w-[300px] mx-auto sm:ltr:ml-0 sm:rtl:mr-0 pb-6 sm:pb-5">
        ...
        />
        <Text>{t('We offer exquisite jewelry and the finest diamonds, paired with exceptional service, making us a trusted name in the luxury market.')}</Text>
      </div>
