...
const SingleProductInvPage: React.FC<{
  ...
  // console.log(handleStoreQty(), '===>>> handleStoreQty');
  ...
  return (
    <div className="pt-6 pb-2 md:pt-7">
      <div className="flex flex-col md:flex-row justify-between gap-7">
        <div className="col-span-5 mb-6 flex-1 overflow-hidden xl:col-span-6 md:mb-8 lg:mb-0">
          {data?.gallery?.length ? (
            <ThumbnailCarousel
        ...
        <div className="flex flex-col justify-start flex-1 col-span-5 shrink-0 xl:col-span-4 gap-[50px]">
          <div className="">
            <div className="">
              <h2 className="text-3xl !leading-[2.75rem] font-bold transition-colors duration-300 text-brand-dark md:text-xl xl:text-[40px] mb-2 capitalize">
                {data?.name}
              </h2>
