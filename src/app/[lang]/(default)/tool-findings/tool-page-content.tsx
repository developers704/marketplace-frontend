...
import ToolFindingsCard from '@/components/cards/toolFindingsCard';
import DebounceSearch from '@/components/common/debounceSearch';
import { SpecialProductSkeletons } from '@/components/ui/skeletons';

const ToolsPageContent = ({ lang }: any) => {
  const { t } = useTranslation(lang, 'tool findings');
  const [selectedItem, setSelectedItem] = useState('All');
  const breadcrumps = useBreadcrumb();
  ...
  const { data: specialProducts, isLoading } =
    useAllSpecialProductQuery('tool finding');
