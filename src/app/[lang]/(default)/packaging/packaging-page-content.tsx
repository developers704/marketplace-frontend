...
import PackagingCard from '@/components/cards/packagingCard';
...
const PackagingPageContent = ({ lang }: any) => {
  ...
  const { data: specialProducts, isLoading } =
    useAllSpecialProductQuery('packages-gws');
...
export default PackagingPageContent;
