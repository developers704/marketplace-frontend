        ...
        {/* <div className="flex flex-col flex-1 col-span-5 shrink-0 xl:col-span-4 xl:ltr:pl-2 xl:rtl:pr-2 p-6 justify-center gap-5 ml-5">
          <div className="pb-3 lg:pb-5">
            <div className="md:mb-2.5 block -mt-1.5">
              <h2 className="text-3xl font-bold transition-colors duration-300 text-brand-dark md:text-xl xl:text-[40px] mb-2 capitalize">
                {data?.name}
              </h2>
              <div className="text-brand-muted">SKU: {data?.sku}</div>
            </div>

            <div className="flex items-center mt-5">
              <div className="text-brand-dark font-bold text-base md:text-xl xl:text-[32px]">
                $ {data?.prices[0].amount}
              </div>
            </div>
          </div>
          <div className="pt-1.5 lg:pt-3 xl:pt-4 space-y-2.5 md:space-y-3.5 flex flex-col lg:flex-row lg:items-center gap-4">
            <Counter
              variant="single"
            ...
            <Button
              ...
              // disabled={data?.stock === 0 || data?.stock === undefined}
            >
