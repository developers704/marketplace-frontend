...
import { MissionSection, VisionSection } from './VisionMissionSection';
import ValuesSection from './ValueSection';
import CeoMessage from './CeoMessage';
import VideoHero from './VideoComponent';
import PresenceSection from './OurPresence';

const backgroundThumbnail = '/assets/images/aboutus/bg.png';
